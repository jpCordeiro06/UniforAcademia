...
class Acessibilidade : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(layout.activity_acessibilidade)
        btn1 = findViewById(id.txtAcessibilidade)
        btn5 = findViewById(id.imgButtonMenu)
        btn6 = findViewById(id.imgButtonProf)
        btn7 = findViewById(id.imgButtonInicio)
